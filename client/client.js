window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		const zh = {
			...
			commentsLoginHint: "本地 dsh web 的嵌入登录会跨站离开页面，回跳后不会携带宿主会话。请在 GitHub 登录和发表评论；这里继续用于阅读。",
		...
		const en = {
			...
			commentsLoginHint: "Embedded sign-in on local dsh web navigates cross-site and returns without the host session. Sign in and post on GitHub; keep reading here.",
