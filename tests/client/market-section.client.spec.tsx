...
describe('MarketSection (jsdom)', () => {
  ...
  it('refreshes README screenshot fallbacks when a newer catalog is accepted (#439)', async () => {
    ...
    vi.stubGlobal('fetch', vi.fn((url: string) => {
      ...
      if (path === '/dsh-market/registry') {
        ...
        registry.plugins = [{
          ...
          category: 'theme',
          description: {
            en: registryCalls === 1 ? 'First catalog generation' : 'Second catalog generation',
            zh: '',
          },
        }]
